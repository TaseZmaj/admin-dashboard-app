...
- Displays the _goods_ that, based on the filter, are being sold the most.
...
5. A **Line chart** that displays the _demand_ of the goods.
...
6. A **Demand card** that displays the _demand_ of the goods numerically.
7. A **Revenue card** that displays the _total revenue_ generated numerically.
8. A **Profit card** that displays the _total profit_ generated numerically.
9. A **Costs card** that display the _total cost_ generated numerically.

Another functionality:

- A comparrison sub-page that includes the time filter. There are two selections for 2 different goods. Upon selecting the time filter and the goods a comparrison will be displayed:
...
The goods page is to include these elements based on the time filter:

- Upon clicking one of the list item - go to a [dynamically generated good page](#Dynamic-services-page) for that particular _service_ just the same as in the Trending services list in [Dashboard homepage](#dashboard-homepage)
- add pagination

2. A **Pie chart** that displays the revenue generated by each of the services.
3. A **Pie chart** that displays the demand of the services.
4. A **Pie chart** that displays how much each service costs to implement (how much the employees are paid to produce that service).

#### Profits page (with Analytics)

<!--TODO: finish the profits page-->
...
- The analytics page is to analyze the performance of employees - "the sales of the salespeople".
- Just as the [Dashboard homepage](#dashboard-homepage) this page will also include the time filter.
...
2. A **Pie chart** that displays the revenue generated by each employee.
3. A **Pie chart** that displays the total number of services done by each employee.

#### Login page

- Upon opening the app this is the first page
