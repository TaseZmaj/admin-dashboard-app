...
The employees page is to analyze the performance of employees - "the sales of the salespeople". Just as the [Dashboard homepage](#dashboard-homepage) this page will also include the time filter.
...
The employees page is to include these elements based on the _time filter_:
