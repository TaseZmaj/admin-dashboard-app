...
export type DataTableType =
  ...
  | "services"
  | "services/tires"
  | "services/undercarriageRepairs"
  | "services/oilFilterChanges"
  | "services/carBattery"
  | "services/autoAc"
  | "services/other"
  | "employees"
  ...
  | "salesChannels"
  | "salesChannels/physicalStores"
  | "salesChannels/onlineStores"
  | "customers"
  | "customers/individuals"
  | "customers/walkInCustomers"
  | "customers/businessAccounts"
  | "customers/wholesalePartners"
  | "orders"
  | "orders/onSite"
  | "orders/online"
  | "reviews"
